...
from ...repository.case.shared_defaults_repository import SharedDefaultsRepository
...
from ..case.edit_lease_service import EditLeaseService
...
from ..template.template_registry_service import TemplateRegistryService
...
def build_workbench_services(
    ...
    services.archive_api = ArchiveTaskApiService(
        ...
        legacy_output_roots=(OUTPUT_BASE, LEGACY_ARCHIVE_OUTPUT_BASE),
    )
    return services
