...
> Spec: `openspec/changes/increase-image-upload-limit/specs/electronic-inspection-record/spec.md`
> 范围：将附件图片单文件上传上限由 10MB 提升至 100MB；前后端保持一致，不改变图片格式、数量、案件总容量或导出规则。

## SharedConstants（Layer 1）
...
## Backend Repository / Service / Controller（Layer 20–22）
