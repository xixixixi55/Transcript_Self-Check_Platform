...
spec_sync_evidence: 已同步到 openspec/specs/electronic-inspection-record/spec.md“检材持有人作为可选审核字段”
...
- `holder_parser_contract: PASS`：SYNTHETIC legacy/new/多检材解析回归证明 new 行内“检材持有人姓名”进入对应 `holder_name`，legacy 保持空值；用户提供的真实样例仅做脱敏计数核对，legacy 1 条中 0 条有结构化持有人，new 3 条中 3 条均识别，不记录姓名或其他业务数据。
...
- 每个检材拥有独立的可选“持有人”字段。
- new 报告的“检材持有人姓名”按行进入对应检材；legacy 无明确字段时为空。
