...
- WHEN 工作人员从案件工作台点击「统一导出」，或从审核编辑界面点击「导出 Word」，并完成 Word 文件名确认
...
- WHEN 工作人员在审核编辑界面点击「导出 Word」、确认文件名并在 Windows 原生目录选择器中选择目录
...
- WHEN 工作人员确认 Word 文件名后关闭或取消 Windows 原生目录选择器
