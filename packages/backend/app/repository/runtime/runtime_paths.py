...
def _source_resource_root(source_module: Path) -> Path:
    """从源码布局中的 packages 锚点解析仓库资源根目录。"""
    for parent in source_module.parents:
        if parent.name == "packages":
            return parent.parent
    raise RuntimePathError("SOURCE_RESOURCE_ROOT_UNAVAILABLE")
...
def resolve_runtime_paths(
    ...
    *,
    ...
    if resource_override:
        ...
        resource_root = _source_resource_root(source_module)
