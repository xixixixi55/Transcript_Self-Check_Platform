...
def _validate_schema(connection: sqlite3.Connection) -> None:
    ...
    if not {"active_case_lease", "task_case_status", "source_case", "archive_attempt_case_status", "archive_context_attempt", "archive_publish_attempt", "archive_publish_fence_active_case", "archive_publish_fence_active_attempt", "archive_publish_fence_reconciliation"}.issubset(indexes):
        raise SchemaIncompatibleError()
