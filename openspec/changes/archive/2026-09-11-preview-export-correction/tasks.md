...
spec_sync_evidence: 设备字段解析、附件表格和 Word 失败合同已进入 electronic-inspection-record living spec；后续变更已将 Python hashlib 与固定 MD5 表头分别收敛为 HashMyFiles 和案件所选哈希，本包旧 delta 不得覆盖这些更新。
