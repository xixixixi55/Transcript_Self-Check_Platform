...
及 T011/T011T 共享合同，T012–T015 尚未实现；Phase 4–5 尚未实现。未实现合同仍只保留在本 delta spec 中，不得提前写成
当前生产事实。
...
- TaskRecord：Phase 1 中是可恢复解析任务和最小归档尝试记录；Phase 3 共享合同已增加归档里程碑、活动和 Worker 状态字段，后续 T013–T015 才实现持久化归档 Worker 与案件卡片摘要事实源。
