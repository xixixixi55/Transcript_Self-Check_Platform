...
MAX_CASE_IMAGE_BYTES = 100 * 1024 * 1024
...
CASE_TRANSITIONS = {
    ...
    "archive_verified": {"exporting_word", "exported", "cancelling"},
    "exporting_word": {"exported", "archive_verified", "cancelling"},
    "exported": {"exported", "record_retention_expired"},
