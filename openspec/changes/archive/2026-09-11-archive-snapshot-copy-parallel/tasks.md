...
workflow_level: 2
status: superseded
superseded_by: direct-source-archive-and-root-name-fix
spec_sync_status: reconciled
spec_sync_evidence: 当前 REQ-ARCHIVE-IMMUTABLE-INPUT 已改为用户确认后的直接源单次 inventory，本包快照并行拷贝 delta 不得重新写入 living spec。
