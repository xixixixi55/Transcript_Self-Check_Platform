...
def _evidence_list(introduction: Mapping[str, Any]) -> None:
    ...
    for item in evidence:
        ...
        for key in ("device_name", "brand", "model", "imei1", "imei2", "serial_number", "unextractable_reason", "device_type_source", "material_type", "material_type_status", "material_type_source", "material_type_diagnostic"):
