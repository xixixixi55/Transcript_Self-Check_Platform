...
| Layer 21 | `packages/backend/app/services/report/report_parser_service.py`、`packages/backend/app/services/document/document_builder_service.py`、`packages/backend/app/services/document/record_generator_service.py` | 默认工具、附件表格、Word 内容与非空校验 |
